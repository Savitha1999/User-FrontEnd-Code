...
const BuyerAssisBuyer = () => {
  ...
  // Fetch Buyer Assistance Requests based on phoneNumber
  useEffect(() => {
  ...
  return (
    ...
    >
      <FaArrowLeft style={{ color: '#30747F', transition: 'color 0.3s ease-in-out' , background:"transparent"}} />
               ...
               <h3 className="m-0 ms-3" style={{fontSize:"15px", fontWeight:"bold"}}> BUYER ASSISTANCE</h3> </div>
